            		...
            		<!-- <div class="col-md-12">
            			<div class="zap-faq-bubble">
            				<div class="faq-section">
            					<a href="" class="fs">Purchasing The Vehicle</a>
            				</div>
            				<div class="faq-section">
            					<a href="" class="fs">Cars Operation</a>
            				</div>
            				<div class="faq-section">
            					<a href="" class="fs">Financial Consideration</a>
            				</div>
            			</div>
            			<div class="zap-faq-data">
            				<br>
            				<ol id="purchasing">
            					<p class="heading">Purchasing The Vehicle</p>
            					<li class="heading">I have an existing car with me that I want to put on the ZAP platform. Is Zoomcar willing to accept that car?</li>
            					<p class="answer">Unfortunately, currently we are not looking at bringing cars that are not brand new onto our platform, primarily due to the complexities of the regulatory framework we need to work under. At a future date, if regulation become more favourable, we may consider this.
            					</p>
            					<li class="heading">Why is Zoomcar accepting only certain car models under ZAP?</li>
            				...
            				<ol id="financing">
            					<p class="heading">Financial Considerations</p>
